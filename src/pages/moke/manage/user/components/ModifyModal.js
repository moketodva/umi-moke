...
class ModifyModal extends PureComponent {
    ...
    render() {
        const { form: { getFieldDecorator }, visible, initialData, roleData, loading, roleLoading } = this.props;
        const formItemLayout = {
            labelCol: { span: 8 },
            wrapperCol: { span: 16 },
        };
        const phoneInputBefore = getFieldDecorator('phonePrefix', {
                    ...
                    <Form.Item label={'手机号'} hasFeedback>
                        {
                            getFieldDecorator('phone', {
                                ...
                                <Input addonBefore={phoneInputBefore} placeholder={'请输入手机号'} style={{ width: 260 }}/>,
                            )
                        }
                    </Form.Item>
                    ...
                    <Form.Item label={'角色'} hasFeedback>
                        {
                            getFieldDecorator('roleIds', {
                                initialValue: initialData.roleIds,
                            })(
